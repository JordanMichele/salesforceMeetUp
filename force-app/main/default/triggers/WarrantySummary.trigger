trigger WarrantySummary on Case (before insert) {
    for(Case myCase : Trigger.new){
        ...
        Decimal warrantyPercentage  = 100 * (myCase.Product_Purchase_Date__c.daysBetween(Date.today()) / myCase.Product_Total_Warranty_Days__c);
        Boolean hasExtendedWarranty = myCase.Product_Has_Extended_Warranty__c;
        String endingStatement      = 'Have a great day!';
